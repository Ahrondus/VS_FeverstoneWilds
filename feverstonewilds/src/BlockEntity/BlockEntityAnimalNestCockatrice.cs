...
namespace FeverstoneWilds
{
    ...
    public class BlockEntityAnimalNestCockatrice : BlockEntity, IAnimalNest
    {
        ...
        public BlockEntityAnimalNestCockatrice()
        {
        }
        ...
        {
            return entity is EntityAgent && ( entity.Code.Path == "cockatrice-female" || entity.Code.Path == "tame-cockatrice-female");
        }
        ...
        public bool TryAddEgg(Entity entity, string chickCode, double incubationTime)
        {
            ...
            eggs++;
            Block replacementBlock = Api.World.GetBlock(new AssetLocation("feverstonewilds:" + Block.FirstCodePart() + "-" + eggs + (eggs > 1 ? "eggs" : "egg")));
        ...
        private void On1500msTick(float dt)
        {
            ...
            if(occupier != null && occupier.Alive)
            {
        ...
        public override void GetBlockInfo(IPlayer forPlayer, StringBuilder dsc)
        {
            ...
            if (fertileCount > 0)
            {
                ...
                if (occupier == null && Block.LastCodePart() == fullCode)
                    dsc.AppendLine(Lang.Get("An animal is needed!"));
            }
            else if (eggCount > 0)
            {
